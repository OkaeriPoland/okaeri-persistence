...
public class JdbcReferencesTest {
    ...
    public void setup() {
        ...
        this.bookRepository = RepositoryDeclaration.of(BookRepository.class).newProxy(this.persistence, this.bookCollection, JdbcReferencesTest.class.getClassLoader());
        this.authorRepository = RepositoryDeclaration.of(AuthorRepository.class).newProxy(this.persistence, this.authorCollection, JdbcReferencesTest.class.getClassLoader());
    }
