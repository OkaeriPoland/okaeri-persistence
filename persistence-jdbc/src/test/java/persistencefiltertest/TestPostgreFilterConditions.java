...
public class TestPostgreFilterConditions {
    ...
    public void test_orderBy_single_asc() {
        ...
        assertEquals("value->>'name' asc", orderBy);
    }
    ...
    public void test_orderBy_single_desc() {
        ...
        assertEquals("value->>'score' desc", orderBy);
    }
    ...
    public void test_orderBy_multiple() {
        ...
        assertEquals("value->>'score' desc, value->>'name' asc, value->>'timestamp' desc", orderBy);
    }
    ...
    public void test_orderBy_nested_path() {
        ...
        assertEquals("value->'user'->'profile'->>'age' asc", orderBy);
    }
}
